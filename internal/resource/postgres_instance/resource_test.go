...
func TestPostgresInstanceModelFromAPI(t *testing.T) {
	...
	if model.PublicIP.ValueString() != "203.0.113.5" {
		t.Errorf("expected public_ip, got %s", model.PublicIP.ValueString())
	}
...
func TestSchema(t *testing.T) {
	...
	computed := []string{"id", "status", "private_ip", "port", "public_ip", "admin_username", "created_at", "updated_at", "tenant_id"}
