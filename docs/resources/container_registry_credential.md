...
- `secret` (String, Sensitive) The `docker login` password. Returned only when the credential is first created, and stored in Terraform state thereafter — it cannot be fetched again.
