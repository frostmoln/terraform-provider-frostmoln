...
- *(postgres_instance)* Never leave an unknown in state on a failed create (#614)
...
- *(deps)* Update module go.frostmoln.internal/oidc to v0.3.26 (#609)

### ⚙️ Miscellaneous Tasks

- *(deps)* Update dependency frostmoln/workflows to v0.14.2 (#607)
...
- *(deps)* Update module go.frostmoln.internal/oidc to v0.3.25 (#597)

## [0.71.2] - 2026-09-19

### 🐛 Bug Fixes

- *(deps)* Update module go.frostmoln.internal/oidc to v0.3.24 (#594)

### ⚙️ Miscellaneous Tasks

- *(deps)* Update dependency frostmoln/workflows to v0.14.0 (#591)
- *(deps)* Update dependency frostmoln/workflows to v0.14.1 (#593)
...
- *(scale_group)* Correct the example's LB pool type and health check enum (#581)
...
- *(orphan)* Adopt-and-track the six remaining create-orphan families (D2 residue) (#565)
...
- *(tenant_default_tags)* Apply_to_existing_on_change (#549)
...
- *(tags)* Read-back hides drift on bucket, five resources cannot clear tags (#531)
...
- *(kubernetes_cluster)* Remove an addon in place instead of replacing the cluster (#520)
...
- *(container_registry)* Report storage as the tenant aggregate, add cache used_bytes (#485)
...
- *(appgw)* Carry the six composed-WAF fields (#461)
